var F=Object.defineProperty;var N=(o,t,r)=>t in o?F(o,t,{enumerable:!0,configurable:!0,writable:!0,value:r}):o[t]=r;var Z=(o,t)=>()=>(t||o((t={exports:{}}).exports,t),t.exports);var v=(o,t,r)=>(N(o,typeof t!="symbol"?t+"":t,r),r);var Q=Z((M,S)=>{(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))d(s);new MutationObserver(s=>{for(const c of s)if(c.type==="childList")for(const g of c.addedNodes)g.tagName==="LINK"&&g.rel==="modulepreload"&&d(g)}).observe(document,{childList:!0,subtree:!0});function r(s){const c={};return s.integrity&&(c.integrity=s.integrity),s.referrerPolicy&&(c.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?c.credentials="include":s.crossOrigin==="anonymous"?c.credentials="omit":c.credentials="same-origin",c}function d(s){if(s.ep)return;s.ep=!0;const c=r(s);fetch(s.href,c)}})();const A=`
    .widget__container * {
...
`;class X extends HTMLUListElement{constructor(){super(),this.style.position="relative",this.style.paddingLeft="30px",this.style.paddingTop="30px",this.toggleBtn=document.createElement("button"),this.toggleBtn.style.position="absolute",this.toggleBtn.style.border="none",this.toggleBtn.style.top="0",this.toggleBtn.style.top="5px",this.toggleBtn.style.cursor="pointer",this.toggleBtn.innerText="Test Button",this.toggleBtn.addEventListener("click",()=>{this.dataset.expanded=!this.isExpanded}),this.appendChild(this.toggleBtn)}get isExpanded(){return this.dataset.expanded!=="false"&&this.dataset.expanded!=null}static get observedAttributes(){return["data-expanded"]}attributeChangedCallback(t,r,d){console.log("name EXP, oldValue EXP, newValue EXP",t,r,d),this.updateStyles()}connectedCallback(){this.updateStyles()}updateStyles(){const t=this.isExpanded?"rotate(90deg)":"";this.toggleBtn.style.transform=t,[...this.children].forEach(r=>{r!==this.toggleBtn&&(r.style.display=this.isExpanded?"":"none")})}}customElements.define("expandable-list",X,{extends:"ul"});(function(o,t){typeof M=="object"&&typeof S<"u"?t(M):typeof define=="function"&&define.amd?define(["exports"],t):t((o=typeof globalThis<"u"?globalThis:o||self).Redux={})})(globalThis,function(o){function t(e){return"Minified Redux error #"+e+"; visit https://redux.js.org/Errors?code="+e+" for the full message or use the non-minified dev environment for full errors. "}var r=typeof Symbol=="function"&&Symbol.observable||"@@observable",d=function(){return Math.random().toString(36).substring(7).split("").join(".")},s={INIT:"@@redux/INIT"+d(),REPLACE:"@@redux/REPLACE"+d(),PROBE_UNKNOWN_ACTION:function(){return"@@redux/PROBE_UNKNOWN_ACTION"+d()}};function c(e){if(typeof e!="object"||e===null)return!1;for(var n=e;Object.getPrototypeOf(n)!==null;)n=Object.getPrototypeOf(n);return Object.getPrototypeOf(e)===n}function g(e,n,i){var a;if(typeof n=="function"&&typeof i=="function"||typeof i=="function"&&typeof arguments[3]=="function")throw Error(t(0));if(typeof n=="function"&&i===void 0&&(i=n,n=void 0),i!==void 0){if(typeof i!="function")throw Error(t(1));return i(g)(e,n)}if(typeof e!="function")throw Error(t(2));var u=e,f=n,C=[],l=C,p=!1;function m(){l===C&&(l=C.slice())}function E(){if(p)throw Error(t(3));return f}function x(h){if(typeof h!="function")throw Error(t(4));if(p)throw Error(t(5));var w=!0;return m(),l.push(h),function(){if(w){if(p)throw Error(t(6));w=!1,m();var b=l.indexOf(h);l.splice(b,1),C=null}}}function y(h){if(!c(h))throw Error(t(7));if(h.type===void 0)throw Error(t(8));if(p)throw Error(t(9));try{p=!0,f=u(f,h)}finally{p=!1}for(var w=C=l,b=0;w.length>b;b++)(0,w[b])();return h}function H(h){if(typeof h!="function")throw Error(t(10));u=h,y({type:s.REPLACE})}function _(){var h,w=x;return(h={subscribe:function(b){if(typeof b!="object"||b===null)throw Error(t(11));function j(){b.next&&b.next(E())}return j(),{unsubscribe:w(j)}}})[r]=function(){return this},h}return y({type:s.INIT}),(a={dispatch:y,subscribe:x,getState:E,replaceReducer:H})[r]=_,a}var O=g;function T(e,n){return function(){return n(e.apply(this,arguments))}}function k(e,n,i){return n in e?Object.defineProperty(e,n,{value:i,enumerable:!0,configurable:!0,writable:!0}):e[n]=i,e}function B(e,n){var i=Object.keys(e);if(Object.getOwnPropertySymbols){var a=Object.getOwnPropertySymbols(e);n&&(a=a.filter(function(u){return Object.getOwnPropertyDescriptor(e,u).enumerable})),i.push.apply(i,a)}return i}function V(e){for(var n=1;arguments.length>n;n++){var i=arguments[n]!=null?arguments[n]:{};n%2?B(Object(i),!0).forEach(function(a){k(e,a,i[a])}):Object.getOwnPropertyDescriptors?Object.defineProperties(e,Object.getOwnPropertyDescriptors(i)):B(Object(i)).forEach(function(a){Object.defineProperty(e,a,Object.getOwnPropertyDescriptor(i,a))})}return e}function P(){for(var e=arguments.length,n=Array(e),i=0;e>i;i++)n[i]=arguments[i];return n.length===0?function(a){return a}:n.length===1?n[0]:n.reduce(function(a,u){return function(){return a(u.apply(void 0,arguments))}})}o.__DO_NOT_USE__ActionTypes=s,o.applyMiddleware=function(){for(var e=arguments.length,n=Array(e),i=0;e>i;i++)n[i]=arguments[i];return function(a){return function(){var u=a.apply(void 0,arguments),f=function(){throw Error(t(15))},C={getState:u.getState,dispatch:function(){return f.apply(void 0,arguments)}},l=n.map(function(p){return p(C)});return f=P.apply(void 0,l)(u.dispatch),V(V({},u),{},{dispatch:f})}}},o.bindActionCreators=function(e,n){if(typeof e=="function")return T(e,n);if(typeof e!="object"||e===null)throw Error(t(16));var i={};for(var a in e){var u=e[a];typeof u=="function"&&(i[a]=T(u,n))}return i},o.combineReducers=function(e){for(var n=Object.keys(e),i={},a=0;n.length>a;a++){var u=n[a];typeof e[u]=="function"&&(i[u]=e[u])}var f,C=Object.keys(i);try{(function(l){Object.keys(l).forEach(function(p){var m=l[p];if(m(void 0,{type:s.INIT})===void 0)throw Error(t(12));if(m(void 0,{type:s.PROBE_UNKNOWN_ACTION()})===void 0)throw Error(t(13))})})(i)}catch(l){f=l}return function(l,p){if(l===void 0&&(l={}),f)throw f;for(var m=!1,E={},x=0;C.length>x;x++){var y=C[x],H=l[y],_=(0,i[y])(H,p);if(_===void 0)throw Error(t(14));E[y]=_,m=m||_!==H}return(m=m||C.length!==Object.keys(l).length)?E:l}},o.compose=P,o.createStore=g,o.legacy_createStore=O,Object.defineProperty(o,"__esModule",{value:!0})});const U={counter:0},G=()=>({type:"increment"});function K(o=U,t){return console.log("type",t.type),t.type==="increment"?{...o,counter:o.counter+1}:t.type==="decrement"?{...o,counter:o.counter-1}:(console.log("state 1",o),o)}const L=Redux.createStore(K);L.getState();L.subscribe(o=>{console.log("TTTTT",L.getState())});class $ extends HTMLLIElement{constructor(){super(),this.style.position="relative",this.toggleBtn=document.createElement("button"),this.toggleBtn.style.position="absolute",this.toggleBtn.style.border="none",this.toggleBtn.style.background="transparent",this.toggleBtn.style.width="100%",this.toggleBtn.style.height="100%",this.toggleBtn.style.left="0",this.toggleBtn.style.top="0px",this.toggleBtn.style.cursor="pointer",this.toggleBtn.innerText="",this.toggleBtn.addEventListener("click",()=>{L.dispatch(G()),L.subscribe(t=>{console.log("state",t)}),this.isExpanded}),this.appendChild(this.toggleBtn)}get isExpanded(){return console.log("this.dataset.id",this.dataset.id),this.dataset.id}static get observedAttributes(){return["data-expanded"]}attributeChangedCallback(t,r,d){console.log("name EXP, oldValue EXP, newValue EXP",t,r,d),this.updateStyles()}connectedCallback(){this.updateStyles()}updateStyles(){console.log("coming")}}customElements.define("menu-list-item",$,{extends:"li"});class q{constructor(t){v(this,"position","");v(this,"open",!1);v(this,"widgetContainer",null);v(this,"headerContainer",null);v(this,"buttonContainer",null);this.defaultTheme={primaryColor:"red",secondaryColor:"rgb(239, 241, 247)",sideMenuBgColor:"#F5F6F7",btnTextColor:"#ffffff",position:"bottom-right"},this.theme=t.theme?t.theme:this.defaultTheme,this.position=this.getPosition(this.theme.position),this.open=!1,this.initialize(),this.injectStyles(),console.log("options",this.theme)}getPosition(t){const[r,d]=t.split("-");return{[r]:"30px",[d]:"30px"}}async initialize(){window.TestFunc=function(){alert(window.PROGNOSIS_WID)};const t=document.createElement("div");t.style.position="fixed",Object.keys(this.position).forEach(O=>t.style[O]=this.position[O]),document.body.appendChild(t),this.headerContainer=document.createElement("div"),this.headerContainer.classList.add("prognosis-chat-header");const r=document.createElement("button");r.style.cursor="pointer",r.style.marginRight="20px",r.innerText="<>",r.classList.add("prognosis-chat-maximize-header"),r.classList.add("prognosis-chat-close-header"),r.addEventListener("click",this.maximizeChatbox.bind(this)),this.headerContainer.appendChild(r);const d=document.createElement("button");d.style.cursor="pointer",d.innerText="x",d.classList.add("prognosis-chat-close-header"),d.addEventListener("click",this.toggleOpen.bind(this)),this.headerContainer.appendChild(d),this.buttonContainer=document.createElement("button"),this.buttonContainer.style.backgroundColor=this.theme.primaryColor,this.buttonContainer.classList.add("button__container");const s=document.createElement("button");s.classList.add("submit__container"),s.innerHTML="Submit",s.addEventListener("click",function(){window.TestFunc()});const c=document.createElement("span");c.innerHTML=R,c.classList.add("widget__icon"),this.widgetIcon=c;const g=document.createElement("span");g.innerHTML=W,g.classList.add("widget__icon","widget__hidden"),this.closeIcon=g,this.buttonContainer.appendChild(this.widgetIcon),this.buttonContainer.appendChild(this.closeIcon),this.buttonContainer.addEventListener("click",this.toggleOpen.bind(this)),this.widgetContainer=document.createElement("div"),this.widgetContainer.classList.add("widget__hidden","widget__container"),this.createWidgetContent(),t.appendChild(this.widgetContainer),t.appendChild(this.buttonContainer)}test(){alert("Test")}createWidgetContent(){this.widgetContainer.innerHTML=`
      <div class="prognosis-sidebar-menu-wrapper" style="background-color: ${this.theme.sideMenuBgColor}">
            ...
            <ul class="prognosis-sidebar-menu-list">
              <li>
                <div class="prognosis-menu-title">${D} <span>Chat</span></div>
