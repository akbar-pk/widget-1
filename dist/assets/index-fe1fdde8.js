var h=Object.defineProperty;var p=(i,t,e)=>t in i?h(i,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):i[t]=e;var d=(i,t,e)=>(p(i,typeof t!="symbol"?t+"":t,e),e);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))o(n);new MutationObserver(n=>{for(const s of n)if(s.type==="childList")for(const r of s.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&o(r)}).observe(document,{childList:!0,subtree:!0});function e(n){const s={};return n.integrity&&(s.integrity=n.integrity),n.referrerPolicy&&(s.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?s.credentials="include":n.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function o(n){if(n.ep)return;n.ep=!0;const s=e(n);fetch(n.href,s)}})();const C=`
    .widget__container * {
...
`;class b extends HTMLUListElement{constructor(){super(),this.style.position="relative",this.style.paddingLeft="30px",this.style.paddingTop="30px",this.toggleBtn=document.createElement("button"),this.toggleBtn.style.position="absolute",this.toggleBtn.style.border="none",this.toggleBtn.style.top="0",this.toggleBtn.style.top="5px",this.toggleBtn.style.cursor="pointer",this.toggleBtn.innerText="Test Button",this.toggleBtn.addEventListener("click",()=>{this.dataset.expanded=!this.isExpanded}),this.appendChild(this.toggleBtn)}get isExpanded(){return this.dataset.expanded!=="false"&&this.dataset.expanded!=null}static get observedAttributes(){return["data-expanded"]}attributeChangedCallback(t,e,o){console.log("name EXP, oldValue EXP, newValue EXP",t,e,o),this.updateStyles()}connectedCallback(){this.updateStyles()}updateStyles(){const t=this.isExpanded?"rotate(90deg)":"";this.toggleBtn.style.transform=t,[...this.children].forEach(e=>{e!==this.toggleBtn&&(e.style.display=this.isExpanded?"":"none")})}}customElements.define("expandable-list",b,{extends:"ul"});const x={counter:0},w=()=>({type:"increment"});function y(i=x,t){return console.log("type",t.type),t.type==="increment"?{...i,counter:i.counter+1}:t.type==="decrement"?{...i,counter:i.counter-1}:(console.log("state 1",i),i)}const l=Redux.createStore(y);l.getState();l.subscribe(i=>{console.log("TTTTT",l.getState())});class L extends HTMLLIElement{constructor(){super(),this.style.position="relative",this.toggleBtn=document.createElement("button"),this.toggleBtn.style.position="absolute",this.toggleBtn.style.border="none",this.toggleBtn.style.background="transparent",this.toggleBtn.style.width="100%",this.toggleBtn.style.height="100%",this.toggleBtn.style.left="0",this.toggleBtn.style.top="0px",this.toggleBtn.style.cursor="pointer",this.toggleBtn.innerText="",this.toggleBtn.addEventListener("click",()=>{l.dispatch(w()),l.subscribe(t=>{console.log("state",t)}),this.isExpanded}),this.appendChild(this.toggleBtn)}get isExpanded(){return console.log("this.dataset.id",this.dataset.id),this.dataset.id}static get observedAttributes(){return["data-expanded"]}attributeChangedCallback(t,e,o){console.log("name EXP, oldValue EXP, newValue EXP",t,e,o),this.updateStyles()}connectedCallback(){this.updateStyles()}updateStyles(){console.log("coming")}}customElements.define("menu-list-item",L,{extends:"li"});class _{constructor(t){d(this,"position","");d(this,"open",!1);d(this,"widgetContainer",null);d(this,"headerContainer",null);d(this,"buttonContainer",null);this.defaultTheme={primaryColor:"red",secondaryColor:"rgb(239, 241, 247)",sideMenuBgColor:"#F5F6F7",btnTextColor:"#ffffff",position:"bottom-right"},this.theme=t.theme?t.theme:this.defaultTheme,this.position=this.getPosition(this.theme.position),this.open=!1,this.initialize(),this.injectStyles(),console.log("options",this.theme)}getPosition(t){const[e,o]=t.split("-");return{[e]:"30px",[o]:"30px"}}async initialize(){window.TestFunc=function(){alert(window.PROGNOSIS_WID)};const t=document.createElement("div");t.style.position="fixed",Object.keys(this.position).forEach(a=>t.style[a]=this.position[a]),document.body.appendChild(t),this.headerContainer=document.createElement("div"),this.headerContainer.classList.add("prognosis-chat-header");const e=document.createElement("button");e.style.cursor="pointer",e.style.marginRight="20px",e.innerText="<>",e.classList.add("prognosis-chat-maximize-header"),e.classList.add("prognosis-chat-close-header"),e.addEventListener("click",this.maximizeChatbox.bind(this)),this.headerContainer.appendChild(e);const o=document.createElement("button");o.style.cursor="pointer",o.innerText="x",o.classList.add("prognosis-chat-close-header"),o.addEventListener("click",this.toggleOpen.bind(this)),this.headerContainer.appendChild(o),this.buttonContainer=document.createElement("button"),this.buttonContainer.classList.add("button__container");const n=document.createElement("button");n.classList.add("submit__container"),n.innerHTML="Submit",n.addEventListener("click",function(){window.TestFunc()});const s=document.createElement("span");s.innerHTML=u,s.classList.add("widget__icon"),this.widgetIcon=s;const r=document.createElement("span");r.innerHTML=m,r.classList.add("widget__icon","widget__hidden"),this.closeIcon=r,this.buttonContainer.appendChild(this.widgetIcon),this.buttonContainer.appendChild(this.closeIcon),this.buttonContainer.addEventListener("click",this.toggleOpen.bind(this)),this.widgetContainer=document.createElement("div"),this.widgetContainer.classList.add("widget__hidden","widget__container"),this.createWidgetContent(),t.appendChild(this.widgetContainer),t.appendChild(this.buttonContainer)}test(){alert("Test")}createWidgetContent(){this.widgetContainer.innerHTML=`
      <div class="prognosis-sidebar-menu-wrapper" style="background-color: ${this.theme.sideMenuBgColor}">
            ...
            <ul class="prognosis-sidebar-menu-list">
              <li>
                <div class="prognosis-menu-title">${f} <span>Chat</span></div>
