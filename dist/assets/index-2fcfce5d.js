var W=Object.defineProperty;var H=(l,t,e)=>t in l?W(l,t,{enumerable:!0,configurable:!0,writable:!0,value:e}):l[t]=e;var C=(l,t,e)=>(H(l,typeof t!="symbol"?t+"":t,e),e);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function e(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerPolicy&&(n.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?n.credentials="include":i.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(i){if(i.ep)return;i.ep=!0;const n=e(i);fetch(i.href,n)}})();const k=`
    .widget__container * {
...
`;class F extends HTMLLIElement{constructor(){super(),this.style.position="relative",this.toggleBtn=document.createElement("button"),this.toggleBtn.style.position="absolute",this.toggleBtn.style.border="none",this.toggleBtn.style.background="transparent",this.toggleBtn.style.width="100%",this.toggleBtn.style.height="100%",this.toggleBtn.style.left="0",this.toggleBtn.style.top="0px",this.toggleBtn.style.cursor="pointer",this.toggleBtn.innerText="",this.toggleBtn.addEventListener("click",()=>{this.isExpanded}),this.appendChild(this.toggleBtn)}hiddenModules(){document.querySelectorAll(".prognosis_main_module").forEach(e=>{e.classList.add("hidden_module")})}get isExpanded(){switch(document.querySelectorAll(".prognosis_main_nav_item").forEach(e=>e.classList.remove("active")),this.dataset.id){case"newChat":this.hiddenModules(),document.getElementById("prognosis_consultation_holder").classList.remove("hidden_module"),document.getElementById("menu_item_new_chat").classList.add("active");break;case"medicalCoding":this.hiddenModules(),document.getElementById("prognosis_medical_coding_holder").classList.remove("hidden_module"),document.getElementById("menu_item_medical_coding").classList.add("active");break;case"explain":this.hiddenModules(),document.getElementById("prognosis_explain_holder").classList.remove("hidden_module"),document.getElementById("menu_item_explain").classList.add("active");case"guideline":this.hiddenModules(),document.getElementById("prognosis_guideline_holder").classList.remove("hidden_module"),document.getElementById("menu_item_guideline").classList.add("active");break}return this.dataset.id}static get observedAttributes(){return["data-expanded"]}attributeChangedCallback(t,e,s){console.log("name EXP, oldValue EXP, newValue EXP",t,e,s),this.updateStyles()}connectedCallback(){this.updateStyles()}updateStyles(){console.log("coming")}}customElements.define("menu-list-item",F,{extends:"li"});class G extends HTMLDivElement{constructor(){super(),this.theme=JSON.parse(localStorage.getItem("prognosisTheme")),console.log("this.options",this.theme.primaryColor),this.currentOutput="",this.inputValue="",this.mainChatLink=document.getElementById("prognosis_e_chat"),this.mainChatLink.classList.add("prognosis_e_chat"),this.mainChatLink.addEventListener("click",()=>{this.chatHomeWrapper.classList.remove("hide_page")}),this.newChatBtn=document.querySelector(".prognosis_e_chat"),this.newChatBtn.addEventListener("click",()=>{this.chatLeftContentBox.classList.remove("hide_section"),this.displayArea.classList.add("hide_section")});const t=`
        ...
        `,e=`
            ...
            left: 5px;
            position: absolute;
        `;this.loaderWrapper=document.createElement("div"),this.loaderWrapper.classList.add("prognosis_message_loader"),this.loaderWrapper.setAttribute("style",t),this.loaderBar=document.createElement("div"),this.loaderBar.classList.add("prognosis_message_loader_bar"),this.loaderBar.setAttribute("style",e),this.loaderWrapper.appendChild(this.loaderBar),this.questions=[{title:"What is Atrial Fibrillation?"},{title:"What is Stroke?"},{title:"What is HF Stage B?"},{title:"What is Hypertension?"},{title:"What is what is Anaemia?"}],this.chatHomeWrapper=document.createElement("div"),this.chatHomeWrapper.classList.add("prognosis_chat_home_wrapper"),this.chatHomeLeft=document.createElement("div"),this.chatHomeLeft.classList.add("prognosis_chat_home_left"),this.chatHomeLogoHolder=document.createElement("div"),this.chatHomeLogoHolder.classList.add("prognosis_chat_home_logo_holder"),this.chatHomeLogoHolder.innerHTML=E,this.chatHomeLeftInner=document.createElement("div"),this.chatHomeLeftInner.classList.add("prognosis_chat_inner_left"),this.chatInnerHeader=document.createElement("div"),this.chatInnerHeader.classList.add("prognosis_chat_inner_left_header"),this.chatLeftHeading=document.createElement("h2"),this.chatLeftHeading.classList.add("prognosis_chat_heading");const s=document.createTextNode("What medical questions can I answer for you today?");this.chatLeftHeading.appendChild(s),this.chatInnerHeader.appendChild(this.chatLeftHeading),this.chatHomeLeftInner.appendChild(this.chatInnerHeader),this.chatHomeLeft.appendChild(this.chatHomeLeftInner),this.chatLeftContentBox=document.createElement("div"),this.chatLeftContentBox.classList.add("prognosis_chat_home_left_content"),this.chatLetListHolder=document.createElement("div"),this.chatLetListHolder.classList.add("prognosis_chat_home_left_list_holder");const i=[{question:"Why is my chest beating fast while resting?",icon:"heart"},{question:"Is my blood pressure medication the right dosage?",icon:"bloodPressure"},{question:"What is risk of stroke for a 35 year old?",icon:"brain"},{question:"Does not drinking  milk make me anaemic?",icon:"food"}];this.chatHomeLeftInner.appendChild(this.chatLeftContentBox),this.generateChatHomeQuestion(i),this.chatLeftContentBox.appendChild(this.chatLetListHolder),this.chatHomeRight=document.createElement("div"),this.chatHomeRight.classList.add("prognosis_chat_home_right"),this.chatHomeWrapper.appendChild(this.chatHomeLeft),this.chatHomeWrapper.appendChild(this.chatHomeRight);const n=document.querySelector(".prognosis__conslutation_holder");n&&n.appendChild(this.chatHomeWrapper),this.questionsWrapper=document.createElement("div"),this.generateQuestion(this.questions),this.questionsWrapper.classList.add("prognosis_pre_qa_wrapper"),this.displayArea=document.createElement("div"),this.displayArea.classList.add("prognosis__consult_display_area"),this.displayArea.classList.add("prognosis__display_area"),this.displayArea.classList.add("hide_section"),this.displayArea.appendChild(this.questionsWrapper),this.chatBubble=document.createElement("div"),this.chatBubble.classList.add("prognosis__chat_bubble_out"),this.chatBubbleInner=document.createElement("div"),this.chatBubbleInner.classList.add("prognosis__chat_bubble_out_inner"),this.progIconHolder=document.createElement("button"),this.progIconHolder.classList.add("prognosis_static_button"),this.progIconHolder.innerHTML=I,this.userChatBubble=document.createElement("div"),this.userChatBubble.classList.add("prognosis__chat_bubble_user"),this.userChatBubbleInner=document.createElement("div"),this.userChatBubbleInner.classList.add("prognosis__chat_bubble_user_inner"),this.userIconHolder=document.createElement("button"),this.userIconHolder.classList.add("prognosis_static_button"),this.userIconHolder.innerHTML=z,this.userChatBubble.appendChild(this.userIconHolder),this.inputBox=document.createElement("TEXTAREA"),this.inputBox.placeholder="Type question",this.inputBox.classList.add("prognosis__consult_inputbox"),this.inputBox.addEventListener("keyup",r=>{this.inputValue=r.target.value,console.log("this.inputValue",this.inputValue),console.log("e",r.target.value)}),this.inputBox.addEventListener("keyup",r=>{r.key==="Enter"&&this.processMessageToChatGPT()}),`${this.theme.primaryColor}${this.theme.btnTextColor}${this.theme.btnTextColor}`,this.submitBtn=document.createElement("button"),this.submitBtn.classList.add("prognosis__consult_submitBtn"),this.submitBtn.innerHTML=w,this.submitBtn.addEventListener("click",()=>{this.processMessageToChatGPT()}),this.chatStopBtn=document.createElement("button"),this.chatStopBtn.classList.add("prognosis_chat_stop_btn"),this.chatStopBtn.innerHTML=B,this.chatStopBtn.title="Stop",this.chatStopBtn.style.display="none",this.chatStopBtn.addEventListener("click",()=>{this.controller&&(this.controller.abort(),this.controller=null,this.clearChatBtn.style.display="flex")});const o=`
                background-color: lightgray;
                color: gray;
                fill: gray;
            `;this.clearChatBtn=document.createElement("button"),this.clearChatBtn.classList.add("prognotsis_clear_chat_btn"),this.clearChatBtn.setAttribute("style",o),this.clearChatBtn.innerText="Clear",this.clearChatBtn.addEventListener("click",()=>{this.displayArea.innerHTML="",this.clearChatBtn.style.display="none",this.displayArea.appendChild(this.questionsWrapper),this.questionsWrapper.classList.remove("hide_section")}),this.clearChatBtn.style.display="none",this.textInputWrapper=document.createElement("div"),this.textInputWrapper.classList.add("prognosis_text_input_wrapper"),this.textInputContainer=document.createElement("div"),this.textInputContainer.classList.add("prognosis_text_input_container"),this.textInputContainer.appendChild(this.inputBox),this.textInputContainer.appendChild(this.submitBtn),this.textInputContainer.appendChild(this.chatStopBtn),this.textInputContainer.appendChild(this.clearChatBtn),this.textInputWrapper.appendChild(this.textInputContainer),this.recordingWrapper=document.createElement("div"),this.recordingWrapper.classList.add("prognosis_recording_wrapper"),this.startRecordBtn=document.createElement("button"),this.startRecordBtn.classList.add("prognosis_start_record_btn"),this.startRecordBtn.style.backgroundColor=this.theme.primaryColor,this.startRecordBtn.innerHTML=L,this.recordDescription=document.createElement("p"),this.recordDescription.classList.add("prognosis_record_desc_text"),this.recordDescription.innerText="Press the mic button to ask a question",this.inputWrapper=document.createElement("div"),this.inputWrapper.classList.add("prognosis__consult_wrap"),this.inputWrapper.appendChild(this.recordingWrapper),this.chatHomeLeftInner.appendChild(this.displayArea),this.chatHomeLeftInner.appendChild(this.textInputWrapper),this.appendChild(this.inputWrapper),this.API_KEY=localStorage.getItem("prognosisOAKey"),this.controller=null}get consult(){console.log("get consult")}async processMessageToChatGPT(){var e;this.chatLeftContentBox.classList.add("hide_section"),this.displayArea.classList.remove("hide_section");let t="";if(t=this.inputValue,t.trim().length){this.questionsWrapper.classList.add("hide_section"),this.chatStopBtn.style.display="flex",this.submitBtn.style.display="none";let s=this.chatBubble.cloneNode(!0),i=this.chatBubbleInner.cloneNode(!0);s.appendChild(this.progIconHolder),s.appendChild(i);let n=this.userChatBubble.cloneNode(!0),o=this.userChatBubbleInner.cloneNode(!0);n.appendChild(o),this.displayArea.appendChild(n),o.innerText=t,this.displayArea.appendChild(s),this.displayArea.appendChild(this.loaderWrapper),this.inputBox.value="",this.inputValue="";const r={model:"gpt-3.5-turbo",messages:[{role:"user",content:t}],stream:!0};console.log("apiRequestBody",r),this.controller=new AbortController;const u=this.controller.signal;try{const g=(e=(await fetch("https://api.openai.com/v1/chat/completions",{method:"POST",headers:{Authorization:"Bearer "+this.API_KEY,"Content-Type":"application/json"},body:JSON.stringify(r),signal:u})).body)==null?void 0:e.getReader(),b=new TextDecoder("utf-8");for(;;){const x=await(g==null?void 0:g.read()),{done:y,value:T}=x;if(y){this.clearChatBtn.style.display="flex";break}const v=b.decode(T).split(`
`).map(p=>p.replace(/^data: /,"").trim()).filter(p=>p!==""&&p!=="[DONE]").map(p=>JSON.parse(p));console.log("parsedLines",v);const a={message:t,direction:"outgoing",sender:"user"};for(const p of v){const{choices:f}=p,{delta:c}=f[0],{content:d}=c;if(console.log("content ltst",d),d){let _="";_+=d,this.currentOutput+=_,console.log("contscontscontsconts",_),i.innerText=this.currentOutput;const Y={message:_,sentTime:"just now",sender:"Prognosis"};setTimeout(()=>{this.displayArea.scrollTop=this.displayArea.scrollHeight},100)}}}}catch(h){u.aborted?(console.log("Request aborted!"),this.loaderWrapper.remove()):(console.log("Error occured while generating."),console.log("Error ",h),this.loaderWrapper.remove())}finally{this.chatStopBtn.style.display="none",this.submitBtn.style.display="flex",this.controller=null,this.inputBox.value="",this.inputValue="",this.loaderWrapper.remove()}}else alert("Please enter a message")}generateQuestion(t){t.forEach(e=>{console.log("element.title",e.title);const s=document.createElement("div");s.classList.add("prognosis_pre_question_block"),s.setAttribute("id",e.title),s.innerText=e.title,s.addEventListener("click",i=>{this.inputValue=i.currentTarget.id,this.processMessageToChatGPT(),this.questionsWrapper.classList.add("hide_section")}),this.questionsWrapper.appendChild(s)})}generateChatHomeQuestion(t){t.forEach(e=>{const s=document.createElement("h4");s.classList.add("prognosis_chat_question_item"),s.setAttribute("id",e.question);const i=document.createElement("span");switch(i.classList.add("prognosis_chat_question_icon"),e.icon){case"heart":i.innerHTML=O;break;case"bloodPressure":i.innerHTML=R;break;case"brain":i.innerHTML=P;break;case"food":i.innerHTML=Z;break}s.appendChild(i);const n=document.createElement("span");n.classList.add("prognosis_question_text_holder"),n.innerText=e.question,s.appendChild(n),s.addEventListener("click",o=>{this.inputValue=o.currentTarget.id,this.processMessageToChatGPT(),this.questionsWrapper.classList.add("hide_section")}),this.chatLetListHolder.appendChild(s)})}askQuestion(t){console.log("question",t.currentTarget.id),this.inputValue=t.currentTarget.id,this.processMessageToChatGPT()}}customElements.define("consultation-component",G,{extends:"div"});class j extends HTMLDivElement{constructor(){super(),this.questions=[{title:"What is Atrial Fibrillation?"},{title:"What is Stroke?"},{title:"What is HF Stage B?"},{title:"What is Hypertension?"},{title:"What is what is Anaemia?"}],this.questionsWrapper=document.createElement("div"),this.questionsWrapper.classList.add("prognosis_pre_qa_wrapper"),this.createQuestion(),this.generateQuestion(this.questions)}createQuestion(){this.appendChild(this.questionsWrapper)}generateQuestion(t){t.forEach(e=>{console.log("element.title",e.title);const s=document.createElement("div");s.classList.add("prognosis_pre_question_block"),s.innerText=e.title,s.addEventListener("click",this.askQuestion(e)),this.questionsWrapper.appendChild(s)})}askQuestion(t){console.log("question",t)}}customElements.define("pre-defined-questions",j,{extends:"div"});class Q extends HTMLDivElement{constructor(){super(),this.theme=JSON.parse(localStorage.getItem("prognosisTheme")),console.log("this.options",this.theme.primaryColor),this.currentOutput="",this.inputValue="",this.questions=[{title:"ICD-10-CM"},{title:"CPT"},{title:"HCPCS"},{title:"DRG"},{title:"SNOMED CT"},{title:"LOINC"}];const t=`
            align-items: center;
            border: 1px solid lightgray;
            border-radius: 15px;
            display: flex;
...
`).map(a=>a.replace(/^data: /,"").trim()).filter(a=>a!==""&&a!=="[DONE]").map(a=>JSON.parse(a));console.log("parsedLines",m);const v={message:t,direction:"outgoing",sender:"user"};for(const a of m){const{choices:p}=a,{delta:f}=p[0],{content:c}=f;if(console.log("content ltst",c),c){let d="";d+=c,this.currentOutput+=d,console.log("contscontscontsconts",d),s.innerText=this.currentOutput;const _={message:d,sentTime:"just now",sender:"Prognosis"};setTimeout(()=>{this.displayArea.scrollTop=this.displayArea.scrollHeight},100)}}}}catch(u){r.aborted?console.log("Request aborted!"):(console.log("Error occured while generating."),console.log("Error ",u)),this.loaderWrapper.remove()}finally{this.chatStopBtn.style.display="none",this.submitBtn.style.display="flex",this.controller=null,this.inputBox.value="",this.inputValue="",this.loaderWrapper.remove()}}else alert("Please enter a message")}generateQuestion(t){t.forEach(e=>{console.log("element.title",e.title);const s=document.createElement("div");s.classList.add("prognosis_pre_question_block"),s.setAttribute("id",e.title),s.innerText=e.title,s.addEventListener("click",i=>{this.inputValue=i.currentTarget.id,this.processMessageToChatGPT(),this.questionsWrapper.classList.add("hide_section")}),this.questionsWrapper.appendChild(s)})}askQuestion(t){console.log("question",t.currentTarget.id),this.inputValue=t.currentTarget.id,this.processMessageToChatGPT()}}customElements.define("medical-coding",Q,{extends:"div"});class $ extends HTMLDivElement{constructor(){super(),this.theme=JSON.parse(localStorage.getItem("prognosisTheme")),console.log("this.options",this.theme.primaryColor),this.currentOutput="",this.inputValue="";const t=`
        ...
        `;this.submitBtn=document.createElement("button"),this.submitBtn.classList.add("prognosis__consult_submitBtn"),this.submitBtn.innerHTML=w,this.submitBtn.setAttribute("style",s),this.submitBtn.addEventListener("click",()=>{this.processMessageToChatGPT()}),this.chatStopBtn=document.createElement("button"),this.chatStopBtn.classList.add("prognosis_chat_stop_btn"),this.chatStopBtn.innerHTML=B,this.chatStopBtn.setAttribute("style",s),this.chatStopBtn.title="Stop",this.chatStopBtn.style.display="none",this.chatStopBtn.addEventListener("click",()=>{this.controller&&(this.controller.abort(),this.controller=null,this.clearChatBtn.style.display="flex")});const i=`
                ...
                color: gray;
                fill: gray;
            `;this.clearChatBtn=document.createElement("button"),this.clearChatBtn.classList.add("prognotsis_clear_chat_btn"),this.clearChatBtn.setAttribute("style",i),this.clearChatBtn.innerText="Clear",this.clearChatBtn.addEventListener("click",()=>{this.displayArea.innerHTML="",this.clearChatBtn.style.display="none",this.displayArea.appendChild(this.questionsWrapper),this.questionsWrapper.classList.remove("hide_section")}),this.clearChatBtn.style.display="none",this.textInputWrapper=document.createElement("div"),this.textInputWrapper.classList.add("prognosis_text_input_wrapper"),this.textInputWrapper.appendChild(this.inputBox),this.textInputWrapper.appendChild(this.submitBtn),this.textInputWrapper.appendChild(this.chatStopBtn),this.textInputWrapper.appendChild(this.clearChatBtn),this.recordingWrapper=document.createElement("div"),this.recordingWrapper.classList.add("prognosis_recording_wrapper"),this.startRecordBtn=document.createElement("button"),this.startRecordBtn.classList.add("prognosis_start_record_btn"),this.startRecordBtn.style.backgroundColor=this.theme.primaryColor,this.startRecordBtn.innerHTML=L,this.recordDescription=document.createElement("p"),this.recordDescription.classList.add("prognosis_record_desc_text"),this.recordDescription.innerText="Press the mic button to ask a question",this.recordingWrapper.appendChild(this.startRecordBtn),this.recordingWrapper.appendChild(this.recordDescription),this.inputWrapper=document.createElement("div"),this.inputWrapper.classList.add("prognosis__consult_wrap"),this.inputWrapper.appendChild(this.recordingWrapper),this.inputWrapper.appendChild(this.textInputWrapper),this.appendChild(this.displayArea),this.appendChild(this.inputWrapper),this.API_KEY=localStorage.getItem("prognosisOAKey"),this.controller=null}get consult(){console.log("get consult")}async processMessageToChatGPT(){var e;let t="";if(t=this.inputValue,t.trim().length){this.questionsWrapper.classList.add("hide_section"),this.chatStopBtn.style.display="flex",this.submitBtn.style.display="none";let s=this.chatBubble.cloneNode(!0),i=this.userChatBubble.cloneNode(!0),n=this.userChatBubbleInner.cloneNode(!0);i.appendChild(n),this.displayArea.appendChild(i),n.innerText=t,this.displayArea.appendChild(s),this.displayArea.appendChild(this.loaderWrapper),this.inputBox.value="",this.inputValue="";const o={model:"gpt-3.5-turbo",messages:[{role:"user",content:"explain what is "+t}],stream:!0};console.log("apiRequestBody",o),this.controller=new AbortController;const r=this.controller.signal;try{const h=(e=(await fetch("https://api.openai.com/v1/chat/completions",{method:"POST",headers:{Authorization:"Bearer "+this.API_KEY,"Content-Type":"application/json"},body:JSON.stringify(o),signal:r})).body)==null?void 0:e.getReader(),g=new TextDecoder("utf-8");for(;;){const b=await(h==null?void 0:h.read()),{done:x,value:y}=b;if(x){this.clearChatBtn.style.display="flex";break}const m=g.decode(y).split(`
`).map(a=>a.replace(/^data: /,"").trim()).filter(a=>a!==""&&a!=="[DONE]").map(a=>JSON.parse(a));console.log("parsedLines",m);const v={message:t,direction:"outgoing",sender:"user"};for(const a of m){const{choices:p}=a,{delta:f}=p[0],{content:c}=f;if(console.log("content ltst",c),c){let d="";d+=c,this.currentOutput+=d,console.log("contscontscontsconts",d),s.innerText=this.currentOutput;const _={message:d,sentTime:"just now",sender:"Prognosis"};setTimeout(()=>{this.displayArea.scrollTop=this.displayArea.scrollHeight},100)}}}}catch(u){r.aborted?(console.log("Request aborted!"),this.loaderWrapper.remove()):(console.log("Error occured while generating."),console.log("Error ",u),this.loaderWrapper.remove())}finally{this.chatStopBtn.style.display="none",this.submitBtn.style.display="flex",this.controller=null,this.inputBox.value="",this.inputValue="",this.loaderWrapper.remove()}}else alert("Please enter a message")}generateQuestion(t){t.forEach(e=>{console.log("element.title",e.title);const s=document.createElement("div");s.classList.add("prognosis_pre_question_block"),s.setAttribute("id",e.title),s.innerText=e.title,s.addEventListener("click",i=>{this.inputValue=i.currentTarget.id,this.processMessageToChatGPT(),this.questionsWrapper.classList.add("hide_section")}),this.questionsWrapper.appendChild(s)})}askQuestion(t){console.log("question",t.currentTarget.id),this.inputValue=t.currentTarget.id,this.processMessageToChatGPT()}}customElements.define("explain-component",$,{extends:"div"});class K extends HTMLDivElement{constructor(){super(),this.theme=JSON.parse(localStorage.getItem("prognosisTheme")),console.log("this.options",this.theme.primaryColor),this.currentOutput="",this.inputValue="";const t=`
            align-items: center;
            border: 1px solid lightgray;
            border-radius: 15px;
            display: flex;
        ...
        `;this.submitBtn=document.createElement("button"),this.submitBtn.classList.add("prognosis__consult_submitBtn"),this.submitBtn.innerHTML=w,this.submitBtn.setAttribute("style",s),this.submitBtn.addEventListener("click",()=>{this.processMessageToChatGPT()}),this.chatStopBtn=document.createElement("button"),this.chatStopBtn.classList.add("prognosis_chat_stop_btn"),this.chatStopBtn.innerHTML=B,this.chatStopBtn.setAttribute("style",s),this.chatStopBtn.title="Stop",this.chatStopBtn.style.display="none",this.chatStopBtn.addEventListener("click",()=>{this.controller&&(this.controller.abort(),this.controller=null,this.clearChatBtn.style.display="flex")});const i=`
                ...
                color: gray;
                fill: gray;
            `;this.clearChatBtn=document.createElement("button"),this.clearChatBtn.classList.add("prognotsis_clear_chat_btn"),this.clearChatBtn.setAttribute("style",i),this.clearChatBtn.innerText="Clear",this.clearChatBtn.addEventListener("click",()=>{this.displayArea.innerHTML="",this.clearChatBtn.style.display="none",this.displayArea.appendChild(this.questionsWrapper),this.questionsWrapper.classList.remove("hide_section")}),this.clearChatBtn.style.display="none",this.textInputWrapper=document.createElement("div"),this.textInputWrapper.classList.add("prognosis_text_input_wrapper"),this.textInputWrapper.appendChild(this.inputBox),this.textInputWrapper.appendChild(this.submitBtn),this.textInputWrapper.appendChild(this.chatStopBtn),this.textInputWrapper.appendChild(this.clearChatBtn),this.recordingWrapper=document.createElement("div"),this.recordingWrapper.classList.add("prognosis_recording_wrapper"),this.startRecordBtn=document.createElement("button"),this.startRecordBtn.classList.add("prognosis_start_record_btn"),this.startRecordBtn.style.backgroundColor=this.theme.primaryColor,this.startRecordBtn.innerHTML=L,this.recordDescription=document.createElement("p"),this.recordDescription.classList.add("prognosis_record_desc_text"),this.recordDescription.innerText="Press the mic button to ask a question",this.recordingWrapper.appendChild(this.startRecordBtn),this.recordingWrapper.appendChild(this.recordDescription),this.inputWrapper=document.createElement("div"),this.inputWrapper.classList.add("prognosis__consult_wrap"),this.inputWrapper.appendChild(this.recordingWrapper),this.inputWrapper.appendChild(this.textInputWrapper),this.appendChild(this.displayArea),this.appendChild(this.inputWrapper),this.API_KEY=localStorage.getItem("prognosisOAKey"),this.controller=null}get consult(){console.log("get consult")}async processMessageToChatGPT(){let t="";if(t=this.inputValue,t.trim().length){this.questionsWrapper.classList.add("hide_section"),this.chatStopBtn.style.display="flex",this.submitBtn.style.display="none";let e=this.chatBubble.cloneNode(!0),s=this.userChatBubble.cloneNode(!0),i=this.userChatBubbleInner.cloneNode(!0);s.appendChild(i),this.displayArea.appendChild(s),i.innerText=t,this.displayArea.appendChild(e),this.displayArea.appendChild(this.loaderWrapper),this.inputBox.value="",this.inputValue="";const n=[t];console.log("apiRequestBody",n),this.controller=new AbortController;const o=this.controller.signal;try{const r=await fetch("https://2t3eh2eevg.execute-api.us-east-1.amazonaws.com/develop/getdiseasewithguidelines",{method:"POST",headers:{Authorization:"Bearer "+this.API_KEY,"Content-Type":"application/json"},body:JSON.stringify(n),signal:o});for(;;);}catch(r){o.aborted?(console.log("Request aborted!"),this.loaderWrapper.remove()):(console.log("Error occured while generating."),console.log("Error ",r),this.loaderWrapper.remove())}finally{this.chatStopBtn.style.display="none",this.submitBtn.style.display="flex",this.controller=null,this.inputBox.value="",this.inputValue="",this.loaderWrapper.remove()}}else alert("Please enter a message")}generateQuestion(t){t.forEach(e=>{console.log("element.title",e.title);const s=document.createElement("div");s.classList.add("prognosis_pre_question_block"),s.setAttribute("id",e.title),s.innerText=e.title,s.addEventListener("click",i=>{this.inputValue=i.currentTarget.id,this.processMessageToChatGPT(),this.questionsWrapper.classList.add("hide_section")}),this.questionsWrapper.appendChild(s)})}askQuestion(t){console.log("question",t.currentTarget.id),this.inputValue=t.currentTarget.id,this.processMessageToChatGPT()}}customElements.define("guideline-component",K,{extends:"div"});class J{constructor(t){C(this,"position","");C(this,"open",!1);C(this,"widgetContainer",null);C(this,"headerContainer",null);C(this,"buttonContainer",null);this.from=t.from,this.defaultTheme={primaryColor:"red",secondaryColor:"rgb(239, 241, 247)",sideMenuBgColor:"#F5F6F7",btnTextColor:"#ffffff",position:"bottom-right"},this.theme=t.theme?t.theme:this.defaultTheme,localStorage.setItem("prognosisTheme",JSON.stringify(this.theme)),console.log("options.prognosisOAKey",t),localStorage.setItem("prognosisOAKey",t.prognosisOAKey),this.position=this.getPosition(this.theme.position),this.open=!1,this.initialize(),this.injectStyles(),this.mainWrapper=document.querySelector(".prognosis__wrapper"),this.sideMenuWrapper=document.querySelector("#prognosis_side_bar_wrapper"),this.sideMenuToggleBtn=document.querySelector("#prognosis_menu_collapse_btn"),this.sideMenuToggleBtn.addEventListener("click",this.toggleSideMenu.bind(this))}getPosition(t){const[e,s]=t.split("-");return{[e]:"30px",[s]:"30px"}}toggleSideMenu(t){console.log("e",t),console.log("e target",t.currentTarget);const e=t.currentTarget;e.classList.contains("collapsed")?(this.mainWrapper.classList.remove("collapsed"),this.mainWrapper.classList.add("expanded"),this.sideMenuWrapper.classList.remove("collapsed"),this.sideMenuWrapper.classList.add("expanded"),e.classList.remove("collapsed"),e.classList.add("expanded")):(this.mainWrapper.classList.remove("expanded"),this.mainWrapper.classList.add("collapsed"),this.sideMenuWrapper.classList.remove("expanded"),this.sideMenuWrapper.classList.add("collapsed"),e.classList.remove("expanded"),e.classList.add("collapsed"))}async initialize(){window.TestFunc=function(){alert(window.PROGNOSIS_WID)};const t=document.createElement("div");t.style.position="fixed",t.style.zIndex="123456789012",Object.keys(this.position).forEach(r=>t.style[r]=this.position[r]),document.body.appendChild(t),this.headerContainer=document.createElement("div"),this.headerContainer.classList.add("prognosis-chat-header");const e=document.createElement("button");e.style.cursor="pointer",e.style.marginRight="20px",e.innerText="<>",e.classList.add("prognosis-chat-maximize-header"),e.classList.add("prognosis-chat-close-header"),e.addEventListener("click",this.maximizeChatbox.bind(this)),this.headerContainer.appendChild(e);const s=document.createElement("button");s.style.cursor="pointer",s.innerText="x",s.classList.add("prognosis-chat-close-header"),s.addEventListener("click",this.toggleOpen.bind(this)),this.headerContainer.appendChild(s),this.buttonContainer=document.createElement("button"),this.buttonContainer.style.backgroundColor=this.theme.primaryColor,this.buttonContainer.classList.add("button__container");const i=document.createElement("button");i.classList.add("submit__container"),i.innerHTML="Submit",i.addEventListener("click",function(){window.TestFunc()});const n=document.createElement("span");n.innerHTML=A,n.classList.add("widget__icon"),this.widgetIcon=n;const o=document.createElement("span");o.innerHTML=S,o.classList.add("widget__icon","widget__hidden"),this.closeIcon=o,this.buttonContainer.appendChild(this.widgetIcon),this.buttonContainer.appendChild(this.closeIcon),this.buttonContainer.addEventListener("click",this.toggleOpen.bind(this)),this.widgetContainer=document.createElement("div"),this.widgetContainer.classList.add("widget__hidden","widget__container"),this.chatHolder=document.createElement("div"),this.chatHolder.classList.add("prognosis_chat_main"),this.createWidgetContent(),t.appendChild(this.widgetContainer),t.appendChild(this.buttonContainer),setTimeout(()=>{document.getElementById("prognosis_consultation_holder").classList.remove("hidden_module"),document.getElementById("menu_item_new_chat").classList.add("active")},0),this.from==="website"&&(this.createWidgetContent(),this.widgetIcon.classList.add("widget__hidden"),this.closeIcon.classList.remove("widget__hidden"),this.widgetContainer.classList.remove("widget__hidden"),this.widgetContainer.appendChild(this.headerContainer),this.buttonContainer.classList.add("btn-main-hidden"),this.widgetContainer.appendChild(this.headerContainer),this.headerContainer.style.display="none",document.getElementById("prognosis_consultation_holder").classList.remove("hidden_module"),this.maximizeChatbox())}createWidgetContent(){this.widgetContainer.innerHTML=`
    <div class="prognosis__wrapper collapsed">
      <div id="prognosis_side_bar_wrapper" class="prognosis-sidebar-menu-wrapper collapsed" style="background-color: ${this.theme.secondaryColor}">
        <div class="aside-wrap" id="prognosis_main_nav_wrapper">
            <a href="https://myprognosis.ai/">${E}</a>
            <div class="prognosis_menu_collapse_btn_holder">
              <button class="prognosis_menu_collapse_btn collapsed" id="prognosis_menu_collapse_btn">
                <span class="collapse_arrow_left">${D}</span>
                <span class="collapse_arrow_right">${N}</span>
              </button>
            </div>
            <ul class="prognosis-sidebar-menu-list">
              <li>
                <div class="prognosis-menu-title active" id="prognosis_e_chat">${V} <span class="prognosis-menu-text">New Chat</span></div>
              ...
              <!--<li>
                <div class="prognosis-menu-title">${M} <span class="prognosis-menu-text">Smart Tasks</span></div>
                <ul class="prognosis-menu-children">
