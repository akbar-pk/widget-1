var H=Object.defineProperty;var k=(l,t,s)=>t in l?H(l,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):l[t]=s;var g=(l,t,s)=>(k(l,typeof t!="symbol"?t+"":t,s),s);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))e(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&e(r)}).observe(document,{childList:!0,subtree:!0});function s(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerPolicy&&(n.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?n.credentials="include":i.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function e(i){if(i.ep)return;i.ep=!0;const n=s(i);fetch(i.href,n)}})();const I=`
    .widget__container * {
...
<svg xmlns="http://www.w3.org/2000/svg" width="27" height="40" viewBox="0 0 27 40" fill="none">
        ...
        `,s=`
            ...
            left: 5px;
            position: absolute;
        `;this.loaderWrapper=document.createElement("div"),this.loaderWrapper.classList.add("prognosis_message_loader"),this.loaderWrapper.setAttribute("style",t),this.loaderBar=document.createElement("div"),this.loaderBar.classList.add("prognosis_message_loader_bar"),this.loaderBar.setAttribute("style",s),this.loaderWrapper.appendChild(this.loaderBar),this.questions=[{title:"What is Atrial Fibrillation?"},{title:"What is Stroke?"},{title:"What is HF Stage B?"},{title:"What is Hypertension?"},{title:"What is what is Anaemia?"}],this.chatHomeWrapper=document.createElement("div"),this.chatHomeWrapper.classList.add("prognosis_chat_home_wrapper"),this.chatHomeLeft=document.createElement("div"),this.chatHomeLeft.classList.add("prognosis_chat_home_left"),this.chatHomeLogoHolder=document.createElement("div"),this.chatHomeLogoHolder.classList.add("prognosis_chat_home_logo_holder"),this.chatHomeLogoHolder.innerHTML=q,this.chatHomeLeftInner=document.createElement("div"),this.chatHomeLeftInner.classList.add("prognosis_chat_inner_left"),this.chatHomeLeftInner.appendChild(this.chatHomeLogoHolder),this.chatInnerHeader=document.createElement("div"),this.chatInnerHeader.classList.add("prognosis_chat_inner_left_header"),this.chatLeftHeading=document.createElement("h2"),this.chatLeftHeading.classList.add("prognosis_chat_heading");const e=document.createTextNode("What medical questions can I answer for you today?");this.chatLeftHeading.appendChild(e),this.chatInnerHeader.appendChild(this.chatLeftHeading),this.chatHomeLeftInner.appendChild(this.chatInnerHeader),this.chatHomeLeft.appendChild(this.chatHomeLeftInner),this.chatLeftContentBox=document.createElement("div"),this.chatLeftContentBox.classList.add("prognosis_chat_home_left_content"),this.chatLetListHolder=document.createElement("div"),this.chatLetListHolder.classList.add("prognosis_chat_home_left_list_holder");const i=[{question:"Why is my chest beating fast while resting?",icon:"heart"},{question:"Is my blood pressure medication the right dosage?",icon:"bloodPressure"},{question:"What is risk of stroke for a 35 year old?",icon:"brain"},{question:"Does not drinking  milk make me anaemic?",icon:"food"}];this.chatHomeLeftInner.appendChild(this.chatLeftContentBox),this.generateChatHomeQuestion(i),this.chatLeftContentBox.appendChild(this.chatLetListHolder),this.chatHomeRight=document.createElement("div"),this.chatHomeRight.classList.add("prognosis_chat_home_right"),this.chatHomeWrapper.appendChild(this.chatHomeLeft),this.chatHomeWrapper.appendChild(this.chatHomeRight);const n=document.querySelector(".prognosis__wrapper");console.log("rootWrapper",n),n&&n.appendChild(this.chatHomeWrapper),this.questionsWrapper=document.createElement("div"),this.generateQuestion(this.questions),this.questionsWrapper.classList.add("prognosis_pre_qa_wrapper"),this.displayArea=document.createElement("div"),this.displayArea.classList.add("prognosis__consult_display_area"),this.displayArea.classList.add("prognosis__display_area"),this.displayArea.appendChild(this.questionsWrapper),this.chatBubble=document.createElement("div"),this.chatBubble.classList.add("prognosis__chat_bubble_out"),this.userChatBubble=document.createElement("div"),this.userChatBubble.classList.add("prognosis__chat_bubble_user"),this.userChatBubbleInner=document.createElement("div"),this.userChatBubbleInner.classList.add("prognosis__chat_bubble_user_inner"),this.userChatBubbleInner.style.backgroundColor=this.theme.primaryColor,this.userChatBubbleInner.style.color="#fff",this.inputBox=document.createElement("TEXTAREA"),this.inputBox.placeholder="Type question",this.inputBox.classList.add("prognosis__consult_inputbox"),this.inputBox.addEventListener("keyup",h=>{this.inputValue=h.target.value,console.log("this.inputValue",this.inputValue),console.log("e",h.target.value)}),this.inputBox.addEventListener("keyup",h=>{h.key==="Enter"&&this.processMessageToChatGPT()});const r=`
            background-color: ${this.theme.primaryColor};
            color: ${this.theme.btnTextColor};
            fill: ${this.theme.btnTextColor};
        `;this.submitBtn=document.createElement("button"),this.submitBtn.classList.add("prognosis__consult_submitBtn"),this.submitBtn.innerHTML=f,this.submitBtn.setAttribute("style",r),this.submitBtn.addEventListener("click",()=>{this.processMessageToChatGPT()}),this.chatStopBtn=document.createElement("button"),this.chatStopBtn.classList.add("prognosis_chat_stop_btn"),this.chatStopBtn.innerHTML=B,this.chatStopBtn.setAttribute("style",r),this.chatStopBtn.title="Stop",this.chatStopBtn.style.display="none",this.chatStopBtn.addEventListener("click",()=>{this.controller&&(this.controller.abort(),this.controller=null,this.clearChatBtn.style.display="flex")});const a=`
                background-color: lightgray;
                color: gray;
                fill: gray;
            `;this.clearChatBtn=document.createElement("button"),this.clearChatBtn.classList.add("prognotsis_clear_chat_btn"),this.clearChatBtn.setAttribute("style",a),this.clearChatBtn.innerText="Clear",this.clearChatBtn.addEventListener("click",()=>{this.displayArea.innerHTML="",this.clearChatBtn.style.display="none",this.displayArea.appendChild(this.questionsWrapper),this.questionsWrapper.classList.remove("hide_section")}),this.clearChatBtn.style.display="none",this.textInputWrapper=document.createElement("div"),this.textInputWrapper.classList.add("prognosis_text_input_wrapper"),this.textInputWrapper.appendChild(this.inputBox),this.textInputWrapper.appendChild(this.submitBtn),this.textInputWrapper.appendChild(this.chatStopBtn),this.textInputWrapper.appendChild(this.clearChatBtn),this.recordingWrapper=document.createElement("div"),this.recordingWrapper.classList.add("prognosis_recording_wrapper"),this.startRecordBtn=document.createElement("button"),this.startRecordBtn.classList.add("prognosis_start_record_btn"),this.startRecordBtn.style.backgroundColor=this.theme.primaryColor,this.startRecordBtn.innerHTML=v,this.recordDescription=document.createElement("p"),this.recordDescription.classList.add("prognosis_record_desc_text"),this.recordDescription.innerText="Press the mic button to ask a question",this.inputWrapper=document.createElement("div"),this.inputWrapper.classList.add("prognosis__consult_wrap"),this.inputWrapper.appendChild(this.recordingWrapper),this.inputWrapper.appendChild(this.textInputWrapper),this.appendChild(this.displayArea),this.appendChild(this.inputWrapper),this.API_KEY=localStorage.getItem("prognosisOAKey"),this.controller=null}get consult(){console.log("get consult")}async processMessageToChatGPT(){var s;let t="";if(t=this.inputValue,t.trim().length){this.questionsWrapper.classList.add("hide_section"),this.chatStopBtn.style.display="flex",this.submitBtn.style.display="none";let e=this.chatBubble.cloneNode(!0),i=this.userChatBubble.cloneNode(!0),n=this.userChatBubbleInner.cloneNode(!0);i.appendChild(n),this.displayArea.appendChild(i),n.innerText=t,this.displayArea.appendChild(e),this.displayArea.appendChild(this.loaderWrapper),this.inputBox.value="",this.inputValue="";const r={model:"gpt-3.5-turbo",messages:[{role:"user",content:t}],stream:!0};console.log("apiRequestBody",r),this.controller=new AbortController;const a=this.controller.signal;try{const p=(s=(await fetch("https://api.openai.com/v1/chat/completions",{method:"POST",headers:{Authorization:"Bearer "+this.API_KEY,"Content-Type":"application/json"},body:JSON.stringify(r),signal:a})).body)==null?void 0:s.getReader(),m=new TextDecoder("utf-8");for(;;){const C=await(p==null?void 0:p.read()),{done:_,value:b}=C;if(_){this.clearChatBtn.style.display="flex";break}const u=m.decode(b).split(`
`).map(o=>o.replace(/^data: /,"").trim()).filter(o=>o!==""&&o!=="[DONE]").map(o=>JSON.parse(o));console.log("parsedLines",u);const T={message:t,direction:"outgoing",sender:"user"};for(const o of u){const{choices:x}=o,{delta:y}=x[0],{content:c}=y;if(console.log("content ltst",c),c){let d="";d+=c,this.currentOutput+=d,console.log("contscontscontsconts",d),e.innerText=this.currentOutput;const E={message:d,sentTime:"just now",sender:"Prognosis"};setTimeout(()=>{this.displayArea.scrollTop=this.displayArea.scrollHeight},100)}}}}catch(h){a.aborted?(console.log("Request aborted!"),this.loaderWrapper.remove()):(console.log("Error occured while generating."),console.log("Error ",h),this.loaderWrapper.remove())}finally{this.chatStopBtn.style.display="none",this.submitBtn.style.display="flex",this.controller=null,this.inputBox.value="",this.inputValue="",this.loaderWrapper.remove()}}else alert("Please enter a message")}generateQuestion(t){t.forEach(s=>{console.log("element.title",s.title);const e=document.createElement("div");e.classList.add("prognosis_pre_question_block"),e.setAttribute("id",s.title),e.innerText=s.title,e.addEventListener("click",i=>{this.inputValue=i.currentTarget.id,this.processMessageToChatGPT(),this.questionsWrapper.classList.add("hide_section")}),this.questionsWrapper.appendChild(e)})}generateChatHomeQuestion(t){t.forEach(s=>{const e=document.createElement("h4");e.classList.add("prognosis_chat_question_item"),e.setAttribute("id",s.question);const i=document.createElement("span");switch(i.classList.add("prognosis_chat_question_icon"),s.icon){case"heart":i.innerHTML=O;break;case"bloodPressure":i.innerHTML=P;break;case"brain":i.innerHTML=R;break;case"food":i.innerHTML=N;break}e.appendChild(i);const n=document.createElement("span");n.classList.add("prognosis_question_text_holder"),n.innerText=s.question,e.appendChild(n),e.addEventListener("click",r=>{this.chatHomeWrapper.classList.add("hide_page"),this.inputValue=r.currentTarget.id,this.processMessageToChatGPT(),this.questionsWrapper.classList.add("hide_section")}),this.chatLetListHolder.appendChild(e)})}askQuestion(t){console.log("question",t.currentTarget.id),this.inputValue=t.currentTarget.id,this.processMessageToChatGPT()}}customElements.define("consultation-component",D,{extends:"div"});class F extends HTMLDivElement{constructor(){super(),this.questions=[{title:"What is Atrial Fibrillation?"},{title:"What is Stroke?"},{title:"What is HF Stage B?"},{title:"What is Hypertension?"},{title:"What is what is Anaemia?"}],this.questionsWrapper=document.createElement("div"),this.questionsWrapper.classList.add("prognosis_pre_qa_wrapper"),this.createQuestion(),this.generateQuestion(this.questions)}createQuestion(){this.appendChild(this.questionsWrapper)}generateQuestion(t){t.forEach(s=>{console.log("element.title",s.title);const e=document.createElement("div");e.classList.add("prognosis_pre_question_block"),e.innerText=s.title,e.addEventListener("click",this.askQuestion(s)),this.questionsWrapper.appendChild(e)})}askQuestion(t){console.log("question",t)}}customElements.define("pre-defined-questions",F,{extends:"div"});class z extends HTMLDivElement{constructor(){super(),this.theme=JSON.parse(localStorage.getItem("prognosisTheme")),console.log("this.options",this.theme.primaryColor),this.currentOutput="",this.inputValue="",this.questions=[{title:"ICD-10-CM"},{title:"CPT"},{title:"HCPCS"},{title:"DRG"},{title:"SNOMED CT"},{title:"LOINC"}];const t=`
            align-items: center;
            border: 1px solid lightgray;
            border-radius: 15px;
            display: flex;
        ...
        `;this.loaderWrapper=document.createElement("div"),this.loaderWrapper.classList.add("prognosis_message_loader"),this.loaderWrapper.setAttribute("style",t),this.loaderBar=document.createElement("div"),this.loaderBar.classList.add("prognosis_message_loader_bar"),this.loaderBar.setAttribute("style",s),this.loaderWrapper.appendChild(this.loaderBar),this.questionsWrapper=document.createElement("div"),this.generateQuestion(this.questions),this.questionsWrapper.classList.add("prognosis_pre_qa_wrapper"),this.displayArea=document.createElement("div"),this.displayArea.classList.add("prognosis__consult_display_area"),this.displayArea.classList.add("prognosis__display_area"),this.displayArea.appendChild(this.questionsWrapper),this.chatBubble=document.createElement("div"),this.chatBubble.classList.add("prognosis__chat_bubble_out"),this.userChatBubble=document.createElement("div"),this.userChatBubble.classList.add("prognosis__chat_bubble_user"),this.userChatBubbleInner=document.createElement("div"),this.userChatBubbleInner.classList.add("prognosis__chat_bubble_user_inner"),this.inputBox=document.createElement("TEXTAREA"),this.inputBox.placeholder="Type question",this.inputBox.classList.add("prognosis__consult_inputbox"),this.inputBox.addEventListener("keyup",n=>{this.inputValue=n.target.value,console.log("this.inputValue",this.inputValue),console.log("e",n.target.value)}),this.inputBox.addEventListener("keyup",n=>{n.key==="Enter"&&this.processMessageToChatGPT()});const e=`
            ...
            color: ${this.theme.btnTextColor};
            fill: ${this.theme.btnTextColor};
        `;this.submitBtn=document.createElement("button"),this.submitBtn.classList.add("prognosis__consult_submitBtn"),this.submitBtn.innerHTML=f,this.submitBtn.setAttribute("style",e),this.submitBtn.addEventListener("click",()=>{this.processMessageToChatGPT()}),this.chatStopBtn=document.createElement("button"),this.chatStopBtn.classList.add("prognosis_chat_stop_btn"),this.chatStopBtn.innerHTML=B,this.chatStopBtn.setAttribute("style",e),this.chatStopBtn.title="Stop",this.chatStopBtn.style.display="none",this.chatStopBtn.addEventListener("click",()=>{this.controller&&(this.controller.abort(),this.controller=null,this.clearChatBtn.style.display="flex")});const i=`
                background-color: lightgray;
                color: gray;
                fill: gray;
...
`).map(o=>o.replace(/^data: /,"").trim()).filter(o=>o!==""&&o!=="[DONE]").map(o=>JSON.parse(o));console.log("parsedLines",u);const T={message:t,direction:"outgoing",sender:"user"};for(const o of u){const{choices:x}=o,{delta:y}=x[0],{content:c}=y;if(console.log("content ltst",c),c){let d="";d+=c,this.currentOutput+=d,console.log("contscontscontsconts",d),e.innerText=this.currentOutput;const E={message:d,sentTime:"just now",sender:"Prognosis"};setTimeout(()=>{this.displayArea.scrollTop=this.displayArea.scrollHeight},100)}}}}catch(h){a.aborted?console.log("Request aborted!"):(console.log("Error occured while generating."),console.log("Error ",h)),this.loaderWrapper.remove()}finally{this.chatStopBtn.style.display="none",this.submitBtn.style.display="flex",this.controller=null,this.inputBox.value="",this.inputValue="",this.loaderWrapper.remove()}}else alert("Please enter a message")}generateQuestion(t){t.forEach(s=>{console.log("element.title",s.title);const e=document.createElement("div");e.classList.add("prognosis_pre_question_block"),e.setAttribute("id",s.title),e.innerText=s.title,e.addEventListener("click",i=>{this.inputValue=i.currentTarget.id,this.processMessageToChatGPT(),this.questionsWrapper.classList.add("hide_section")}),this.questionsWrapper.appendChild(e)})}askQuestion(t){console.log("question",t.currentTarget.id),this.inputValue=t.currentTarget.id,this.processMessageToChatGPT()}}customElements.define("medical-coding",z,{extends:"div"});class G extends HTMLDivElement{constructor(){super(),this.theme=JSON.parse(localStorage.getItem("prognosisTheme")),console.log("this.options",this.theme.primaryColor),this.currentOutput="",this.inputValue="";const t=`
            align-items: center;
            border: 1px solid lightgray;
            border-radius: 15px;
            display: flex;
...
`).map(o=>o.replace(/^data: /,"").trim()).filter(o=>o!==""&&o!=="[DONE]").map(o=>JSON.parse(o));console.log("parsedLines",u);const T={message:t,direction:"outgoing",sender:"user"};for(const o of u){const{choices:x}=o,{delta:y}=x[0],{content:c}=y;if(console.log("content ltst",c),c){let d="";d+=c,this.currentOutput+=d,console.log("contscontscontsconts",d),e.innerText=this.currentOutput;const E={message:d,sentTime:"just now",sender:"Prognosis"};setTimeout(()=>{this.displayArea.scrollTop=this.displayArea.scrollHeight},100)}}}}catch(h){a.aborted?(console.log("Request aborted!"),this.loaderWrapper.remove()):(console.log("Error occured while generating."),console.log("Error ",h),this.loaderWrapper.remove())}finally{this.chatStopBtn.style.display="none",this.submitBtn.style.display="flex",this.controller=null,this.inputBox.value="",this.inputValue="",this.loaderWrapper.remove()}}else alert("Please enter a message")}generateQuestion(t){t.forEach(s=>{console.log("element.title",s.title);const e=document.createElement("div");e.classList.add("prognosis_pre_question_block"),e.setAttribute("id",s.title),e.innerText=s.title,e.addEventListener("click",i=>{this.inputValue=i.currentTarget.id,this.processMessageToChatGPT(),this.questionsWrapper.classList.add("hide_section")}),this.questionsWrapper.appendChild(e)})}askQuestion(t){console.log("question",t.currentTarget.id),this.inputValue=t.currentTarget.id,this.processMessageToChatGPT()}}customElements.define("explain-component",G,{extends:"div"});class Q extends HTMLDivElement{constructor(){super(),this.theme=JSON.parse(localStorage.getItem("prognosisTheme")),console.log("this.options",this.theme.primaryColor),this.currentOutput="",this.inputValue="";const t=`
            align-items: center;
            border: 1px solid lightgray;
            border-radius: 15px;
            display: flex;
    ...
    <div class="prognosis__wrapper">
      <div class="prognosis-sidebar-menu-wrapper" style="background-color: ${this.theme.secondaryColor}">
        <div class="aside-wrap">
            <a href="https://myprognosis.ai/">${q}</a>
            <ul class="prognosis-sidebar-menu-list">
              <li>
                <div class="prognosis-menu-title" id="prognosis_e_chat">${V} <span>Chat</span></div>
              ...
              <li>
                <div class="prognosis-menu-title">${M} <span>Smart Tasks</span></div>
                <ul class="prognosis-menu-children">
