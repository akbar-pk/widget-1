var W=Object.defineProperty;var H=(l,t,s)=>t in l?W(l,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):l[t]=s;var g=(l,t,s)=>(H(l,typeof t!="symbol"?t+"":t,s),s);(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))e(i);new MutationObserver(i=>{for(const n of i)if(n.type==="childList")for(const r of n.addedNodes)r.tagName==="LINK"&&r.rel==="modulepreload"&&e(r)}).observe(document,{childList:!0,subtree:!0});function s(i){const n={};return i.integrity&&(n.integrity=i.integrity),i.referrerPolicy&&(n.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?n.credentials="include":i.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function e(i){if(i.ep)return;i.ep=!0;const n=s(i);fetch(i.href,n)}})();const k=`
    .widget__container * {
...
`).map(o=>o.replace(/^data: /,"").trim()).filter(o=>o!==""&&o!=="[DONE]").map(o=>JSON.parse(o));console.log("parsedLines",u);const T={message:t,direction:"outgoing",sender:"user"};for(const o of u){const{choices:x}=o,{delta:y}=x[0],{content:c}=y;if(console.log("content ltst",c),c){let d="";d+=c,this.currentOutput+=d,console.log("contscontscontsconts",d),e.innerText=this.currentOutput;const E={message:d,sentTime:"just now",sender:"Prognosis"};setTimeout(()=>{this.displayArea.scrollTop=this.displayArea.scrollHeight},100)}}}}catch(h){a.aborted?(console.log("Request aborted!"),this.loaderWrapper.remove()):(console.log("Error occured while generating."),console.log("Error ",h),this.loaderWrapper.remove())}finally{this.chatStopBtn.style.display="none",this.submitBtn.style.display="flex",this.controller=null,this.inputBox.value="",this.inputValue="",this.loaderWrapper.remove()}}else alert("Please enter a message")}generateQuestion(t){t.forEach(s=>{console.log("element.title",s.title);const e=document.createElement("div");e.classList.add("prognosis_pre_question_block"),e.setAttribute("id",s.title),e.innerText=s.title,e.addEventListener("click",i=>{this.inputValue=i.currentTarget.id,this.processMessageToChatGPT(),this.questionsWrapper.classList.add("hide_section")}),this.questionsWrapper.appendChild(e)})}askQuestion(t){console.log("question",t.currentTarget.id),this.inputValue=t.currentTarget.id,this.processMessageToChatGPT()}}customElements.define("explain-component",z,{extends:"div"});class G extends HTMLDivElement{constructor(){super(),this.theme=JSON.parse(localStorage.getItem("prognosisTheme")),console.log("this.options",this.theme.primaryColor),this.currentOutput="",this.inputValue="";const t=`
            align-items: center;
            border: 1px solid lightgray;
            border-radius: 15px;
            display: flex;
      ...
      <div class="prognosis-sidebar-menu-wrapper" style="background-color: ${this.theme.secondaryColor}">
        <div class="aside-wrap">
            ...
            <ul class="prognosis-sidebar-menu-list">
              <li>
                <div class="prognosis-menu-title" id="prognosis_e_chat">${S} <span>Chat</span></div>
              ...
              <li>
                <div class="prognosis-menu-title">${I} <span>Smart Tasks</span></div>
                <ul class="prognosis-menu-children">
