...
class Guidelines extends HTMLDivElement {
    constructor() {
        super();
    ...
    async processMessageToChatGPT() {
        ...
        try {
            const streamChat = await fetch("https://2t3eh2eevg.execute-api.us-east-1.amazonaws.com/develop/getdiseasewithguidelines", 
            {
              method: "POST",
              headers: {
...
customElements.define("guideline-component", Guidelines, {
   extends: "div"
})